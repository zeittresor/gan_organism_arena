...
const MODEL_VERSION: String = "arena-biology-10"
...
func model_description() -> Dictionary:
    return {"schema": "arena.observation/1", "model": MODEL_VERSION, "version": "1.0.0-alpha37", "step_seconds": 1.0 / 12.0,
...
func organism_data(org, include_genome: bool) -> Dictionary:
    ...
    var item: Dictionary = {"id": org.organism_id, "parents": [org.parent_a, org.parent_b], "family": org.genome.family_id, "generation": org.genome.generation,
        ...
        "behavior": org.behavior_state, "genetic_health": org.genome.genetic_health(), "heterozygosity": org.genome.heterozygosity(), "in_water": org.in_water, "airborne": org.airborne, "rooted": org.rooted}
